...
import { Divider, Drawer, List, ListItem, ListItemIcon, ListItemText, Tooltip } from '@mui/material';
...
import { auxLink, handleTitleSection, ILink } from './tabs';
...
const MainMenu = () => {
	...
	const [links, setLink] = useState<ILink[]>([]);
			...
			<div className={classes.root}>
				...
				>
					<Toolbar>
						...
						{user ? (
							<div>
								<Tooltip title={user.id_department.name}>
									<IconButton
										sx={sxStyles}
